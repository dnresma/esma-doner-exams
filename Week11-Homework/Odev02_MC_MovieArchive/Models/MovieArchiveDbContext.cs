...
using Odev02_MC_MovieArchive.Models.Entities;

namespace Odev02_MC_MovieArchive.Models;
...
public class MovieArchiveDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Movie>().HasData(
            ...
            new Movie { Id = 3, Title = "The Matrix", Director = "Lana Wachowski, Lilly Wachowski", ReleaseYear = 1999 },
